  ...
  <div class="row">
    ...
    <div class="span9">
      ...
      <div class="alert alert-info">
        <strong><i class="icon-user icon-large"></i>&nbsp;Lesson 2</strong>
      </div>
      <video id="video1" width="650">
        <source src="videos\Guspy_Warrior_-_Joze_[Official_HD_Video]_October_2016_Zimdancehall.mp4" type="video/mp4" />
